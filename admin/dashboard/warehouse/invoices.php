...
<html lang="it">
    <head>
        <title>Magazzino > Fatture &middot; C'est Lux</title>
        <meta charset="UTF-8">
    ...
    <body id="clx-admin-loggedIn-dashboard">
                        ...
                        <div class="warehouse-index-holder row">
                            <div class="clx-tab-holder" theme="clx-admin-dashboard">
                                    <div class="tabs-holder">
                                        <ul>
                                            <li class="active" data-tab-target="active_invoices">fatture attive</li>
                                            <li data-tab-target="completed_invoices">fatture completate</li>
                                            <li data-tab-target="cancelledClx_invoices">fatture annullate da c'est lux</li>
                                        </ul>
                                    </div>
                                    <div class="tab-content">
                                        <!-- active_invoices -->
                                        <div id="active_invoices" class="tabbed active">
                                            <div class="tabbed-inner">
                                                
                                            </div>
                                        </div><!-- // active_invoices -->
                                        <!-- completed_invoices -->
                                        <div id="completed_invoices" class="tabbed disabled">
                                            <div class="tabbed-inner">
                                                
                                            </div>
                                        </div><!-- // completed_invoices -->
                                        <!-- cancelledClx_invoices -->
                                        <div id="cancelledClx_invoices" class="tabbed disabled">
                                            <div class="tabbed-inner">
                                                
                                            </div>
                                        </div><!-- // cancelledClx_invoices -->
                                    </div>
                                </div>
                        </div>
                    </div>
        ...
        <script>clx_dashboard.hm_trigger_sided("w_invoices");</script>
