...
<html lang="it">
    <head>
        <title>Magazzino > Merce &middot; C'est Lux</title>
        <meta charset="UTF-8">
    ...
    <body id="clx-admin-loggedIn-dashboard">
                        ...
                        <div class="warehouse-index-holder row">
                            <div class="clx-tab-holder" theme="clx-admin-dashboard">
                                    <div class="tabs-holder">
                                        <ul>
                                            <li class="active" data-tab-target="active_orders">merce in magazzino</li>
                                            <li data-tab-target="completed_orders">merce spedita</li>
                                            <li data-tab-target="cancelledClx_orders">merce di stock</li>
                                            <li data-tab-target="cancelledCustomer_orders">merce bloccata alla dogana</li>
                                            <li data-tab-target="cancelledDeliveryCompany_orders">merce in sospeso</li>
                                        </ul>
                                    </div>
                                    <div class="tab-content">
                                        ...
                                        <!-- cancelledDeliveryCompany_orders -->
                                        <div id="cancelledDeliveryCompany_orders" class="tabbed disabled">
                                            <div class="tabbed-inner">
                                                
                                            </div>
                                        </div><!-- // cancelledDeliveryCompany_orders -->
                                    </div>
                                </div>
                        </div>
                    </div>
        ...
        <script>clx_dashboard.hm_trigger_sided("w_goods");</script>
